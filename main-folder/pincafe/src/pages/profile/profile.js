...
import { faShoppingCart, faSearch , faUser,faLeftLong, faClose, faArrowRight, faLocationDot, faThLarge } from '@fortawesome/free-solid-svg-icons';
                ...
                <div className='inset-modal'>
                    ...
                    <form>
                        <div className='map'>
                            ...
                            <iframe width="100%" height="100%" frameborder="0" scrolling="no" marginheight="0" marginwidth="0" id="gmap_canvas" src="https://maps.google.com/maps?width=523&amp;height=403&amp;hl=en&amp;q=%20qaemshahr+()&amp;t=&amp;z=12&amp;ie=UTF8&amp;iwloc=B&amp;output=embed"></iframe>
